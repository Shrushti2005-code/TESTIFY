    ...
    <div style={s.page}>
      ...
      {isMobile && sidebarOpen && (
        <div style={s.mobileMenu}>
          ...
          <button onClick={logout} style={s.mobileLogoutBtn}>Sign Out</button>
        </div>
      )}
        ...
        <div style={s.main}>
          ...
          {isMobile && (
            <div style={s.mobileSectionHeader}>
              <h2 style={s.mobileSectionTitle}>{tabs.find(t => t.key === tab)?.label}</h2>
            </div>
          )}
          <div style={{ ...s.content, padding: isMobile ? "16px" : "28px 32px" }}>
            {tab === "create"   && <CreateTestTab email={email} isMobile={isMobile} />}
...
function CreateTestTab({ email, isMobile }) {
...
const s = {
  page:             { minHeight: "100vh", display: "flex", flexDirection: "column", fontFamily: "'Poppins',sans-serif", background: "#F1F5F9" },
  mobileTopbar:     { background: "#1E3A8A", padding: "14px 20px", display: "flex", alignItems: "center", justifyContent: "space-between" },
  menuBtn:          { background: "none", border: "1px solid #3B82F6", borderRadius: 8, color: "#fff", fontSize: 18, padding: "4px 12px", cursor: "pointer" },
  mobileMenu:       { background: "#1E3A8A", display: "flex", flexDirection: "column", borderBottom: "2px solid #1E40AF" },
  mobileMenuBtn:    { padding: "14px 20px", background: "transparent", border: "none", color: "#93C5FD", fontSize: 14, fontWeight: 500, cursor: "pointer", textAlign: "left", display: "flex", alignItems: "center" },
  mobileLogoutBtn:  { margin: "8px 16px 16px", padding: "10px", background: "none", border: "1px solid #1E40AF", borderRadius: 10, color: "#93C5FD", fontSize: 12, cursor: "pointer", textAlign: "center" },
  mobileSectionHeader: { background: "#fff", padding: "14px 16px", borderBottom: "1px solid #E2E8F0" },
  mobileSectionTitle:  { fontSize: 18, fontWeight: 700, color: "#1E293B", margin: 0 },
  ...
  listCard:         { background: "#fff", borderRadius: 12, padding: "14px 16px", display: "flex", alignItems: "center", justifyContent: "space-between", border: "1px solid #E2E8F0", boxShadow: "0 1px 4px rgba(0,0,0,0.04)", gap: 8 },
  listCardLeft:     { display: "flex", alignItems: "center", gap: 12, minWidth: 0 },
  listIcon:         { width: 40, height: 40, borderRadius: 10, background: "#EFF6FF", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 18, flexShrink: 0 },
  listTitle:        { fontWeight: 600, fontSize: 13, color: "#1E293B", marginBottom: 2, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis", maxWidth: 160 },
  listSub:          { fontSize: 11, color: "#94A3B8", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis", maxWidth: 160 },
  qBadge:           { background: "#EFF6FF", color: "#1E3A8A", fontSize: 11, fontWeight: 700, padding: "3px 8px", borderRadius: 20, whiteSpace: "nowrap" },
  markBadge:        { background: "#FEF3C7", color: "#92400E", fontSize: 11, fontWeight: 700, padding: "3px 8px", borderRadius: 20, whiteSpace: "nowrap" },
